...
public class PressurePadScript : InteractiveObject
{
    ...
    void Update()
    {
        ...
        if (_moving)
        {
            ...
            {
                padObject.transform.localPosition = Vector3.Slerp(padObject.transform.localPosition, new Vector3(0, -heightDepression, 0),
                                                        Time.deltaTime * 4.0f);
            ...
            {
                padObject.transform.localPosition = Vector3.Slerp(padObject.transform.localPosition, Vector3.zero, Time.deltaTime * 4.0f);
    ...
    void OnTriggerExit(Collider body)
    {
        ...
        {
            if (_collidingObjects[i] != body) continue;
